...
import { Card, Button, Modal, Row, Col, Pagination, Select, Input, Form, Spin, Tag, Upload, message as antdMessage } from 'antd';
...
function ListJobsPage() {
  ...
  const handleApplySubmit = async (values) => {
    try {
      await axios.post(`${constants.BASE_URL}/seeker/jobs/apply`, {
    ...
    <div className="p-6">
      ...
      {selectedJob && (
        ...
        >
          ...
          {isApplyVisible && (
            <Form layout="vertical" onFinish={handleApplySubmit} className="mt-4">
              {userInfo.resume && (
                <Form.Item>
              ...
              <Form.Item label="Resume" required>
                <Upload beforeUpload={handleResumeUpload} maxCount={1} accept=".pdf">
